...
const getFields = formType => {
  if (formType === 'signup') return signup
  else if (formType === 'signin') return signin
}

const getInitVals = formType => {
  if (formType === 'signup') return signupInitVals
  else if (formType === 'signin') return signinInitVals
}
